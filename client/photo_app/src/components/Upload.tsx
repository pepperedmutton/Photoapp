...
const UploadPhoto: React.FC = () => {
  ...
  return (
    <div className="auth-bg" style={{ minHeight: '100vh', background: '#f4f4f4' }}>
      <header style={{ background: '#0077cc', color: '#fff', padding: '1rem', textAlign: 'center', position: 'relative' }}>
        <div style={{ fontWeight: 700, fontSize: '1.5rem' }}>ProCamShare</div>
        <a href="/" style={{
          position: 'absolute', left: 20, top: 20, background: '#fff', color: '#0077cc',
          padding: '0.5rem 1rem', borderRadius: 8, textDecoration: 'none', fontWeight: 600
        }}>🏠 Home</a>
      </header>
      <main style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
        ...
        >
          ...
          >
            {!preview && <span>Drag &amp; drop a photo here, or click to select</span>}
            <input
              type="file"
              accept="image/*"
              style={{ display: 'none' }}
          ...
          <div className="status-message" style={{ textAlign: 'center', color: '#0077cc', minHeight: '1.5em' }}>
            {statusMessage}
          </div>
        </form>
      </main>
      <footer style={{ background: '#0077cc', color: '#fff', textAlign: 'center', padding: '1rem' }}>
